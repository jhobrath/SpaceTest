...
namespace GalagaFighter.Core.Handlers.Collisions
{
    ...
    {
        bool HasCollision(GameObject obj1, GameObject obj2, float? minimumDistance = null);
    }
    
    public class NearbyCollisionDetector : INearbyCollisionDetector
    {
        public bool HasCollision(GameObject obj1, GameObject obj2, float? minimumDistance = null)
        {
