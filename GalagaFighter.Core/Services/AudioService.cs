...
namespace GalagaFighter.Core.Services
{
    public static class AudioService
    {
        ...
        private static Sound iceHitSound;
        private static Sound wallStickSound;
        private static Sound explosionConversionSound;
        private static Sound burningSound;
        ...
        public static void PlayShootSound() => Raylib.PlaySound(shootSound);
        public static void PlayHitSound() => Raylib.PlaySound(hitSound);
        public static void PlayIceHitSound() => Raylib.PlaySound(iceHitSound);
        public static void PlayWallStickSound() => Raylib.PlaySound(wallStickSound);
        public static void PlayExplosionConversionSound() => Raylib.PlaySound(explosionConversionSound);
        public static void PlayPowerUpSound() => Raylib.PlaySound(powerUpSound);
        public static void PlayBurningSound() => Raylib.PlaySound(burningSound);
        ...
        private static Sound LoadSoundFile(string filename)
        {
        ...
        private static void CreateFallbackSounds()
        {
            try
            {
        ...
        private static byte[] CreateWAVFile(float[] samples, int sampleRate, int channels)
        {
        ...
        public static void StopMagnetSound()
        {
            Raylib.StopSound(magnetSound);
        }
    }
}